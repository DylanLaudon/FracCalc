...
public class FracCalc {
    ...
    public static String produceAnswer(String frac) {
        ...
        //Checks if a 0 is being multiplied
        if ((fullFraction1.equals("0") || fullFraction2.equals("0")) && (sign.equals("*") || sign.equals("/"))) {
            return 0 + "";
        }
        ...
        if (denominator1 == 0) {
            ...
            newNum = numerator1 * denominator2;
            newDen = denominator1 * numerator2;
        }
